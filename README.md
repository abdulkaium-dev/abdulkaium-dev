...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
  ...
  <div style="flex: 1 1 250px; max-width: 300px; text-align: center; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: transform 0.3s;">
    <a href="https://fascinating-seahorse-1ef1af.netlify.app/" target="_blank">
      <img src="https://i.postimg.cc/02wKmwGc/12hostelmanage.png" width="100%" alt="Hostel Management System"/>
    </a>
  ...
  <div style="flex: 1 1 250px; max-width: 300px; text-align: center; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: transform 0.3s;">
    <a href="https://zesty-strudel-2c6569.netlify.app/" target="_blank">
      <img src="https://i.postimg.cc/g0NH5ZT3/11productreco.png" width="100%" alt="Product Recommendation System"/>
    </a>
    <div style="padding: 10px;">
  ...
  <div style="flex: 1 1 250px; max-width: 300px; text-align: center; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: transform 0.3s;">
    <a href="https://cosmic-medovik-450350.netlify.app/" target="_blank">
      <img src="https://i.postimg.cc/g2wwd6jv/10freelancer.png" width="100%" alt="Freelance Task Marketplace"/>
    </a>
    <div style="padding: 10px;">
